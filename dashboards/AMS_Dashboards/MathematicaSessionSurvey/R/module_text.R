...
textServer <- function(id) {
  ...
  moduleServer(id, function(input, output, session) {
    ...
    observeEvent(c(input$refresh1, input$site, input$role, input$course, input$quote_length, input$date_slider, input$facilitator), {
    ...
    observeEvent(c(input$refresh2, input$site, input$role, input$course, input$quote_length, input$date_slider, input$facilitator), {
    ...
    observeEvent(c(input$refresh3, input$site, input$role, input$course, input$quote_length, input$date_slider, input$facilitator), {
