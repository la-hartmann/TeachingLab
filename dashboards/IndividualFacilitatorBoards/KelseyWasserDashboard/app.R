...
# Get data
facilitator_data <- read_sheet("https://docs.google.com/spreadsheets/d/1xkDj4lOyyTzaruYN6WVn_p-_HBTU2f1SdD1_ELjzLVs/edit#gid=2033422707")

# Define UI for application that draws a histogram
ui <- navbarPage(

  # Application title
  titlePanel("Welcome to your dashboard Kelsey Wasser"),
