...
# Get data
facilitator_data <- read_sheet("https://docs.google.com/spreadsheets/d/18CzsGZauHtZK4AohOMDEEadQ83VHmHtdff4C3TrJRW4/edit#gid=1176588829")

# Define UI for application that draws a histogram
ui <- navbarPage(

  # Application title
  titlePanel("Welcome to your dashboard Kristen Taylor"),
