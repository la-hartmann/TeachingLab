...
# Get data
facilitator_data <- read_sheet("https://docs.google.com/spreadsheets/d/12YS_Ny8jEUSzJIoNtm0tf9--8e_Y3sabsmQaezte36I/edit#gid=1260853879")

# Define UI for application that draws a histogram
ui <- navbarPage(

  # Application title
  titlePanel("Welcome to your dashboard Lashana Pollard"),
