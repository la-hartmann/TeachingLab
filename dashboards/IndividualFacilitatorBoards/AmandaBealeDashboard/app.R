...
# Get data
facilitator_data <- read_sheet("https://docs.google.com/spreadsheets/d/1CP3kDmoy-nfKMMukUPI9Ezr-nyha0k0fHXkJMrD0ofo/edit#gid=740709701")

# Define UI for application that draws a histogram
ui <- navbarPage(

  # Application title
  titlePanel("Welcome to your dashboard Amanda Beale"),
