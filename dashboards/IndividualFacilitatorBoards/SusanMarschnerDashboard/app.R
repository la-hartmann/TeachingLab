...
# Get data
facilitator_data <- read_sheet("https://docs.google.com/spreadsheets/d/1azQCo0KKG74BYKT6P5yJQ16CrWia1yzBzo3F2H3absA/edit#gid=899930854")

# Define UI for application that draws a histogram
ui <- navbarPage(

  # Application title
  titlePanel("Welcome to your dashboard Susan Marschner"),
