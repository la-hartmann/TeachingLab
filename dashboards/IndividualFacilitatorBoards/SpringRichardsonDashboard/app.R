...
# Get data
facilitator_data <- read_sheet("https://docs.google.com/spreadsheets/d/16r4Ktu83ixnz2MHqSFL60_3-aajL_KRy0bijoy7Tdro/edit#gid=1317318059")

# Define UI for application that draws a histogram
ui <- navbarPage(

  # Application title
  titlePanel("Welcome to your dashboard Spring Richardson"),
