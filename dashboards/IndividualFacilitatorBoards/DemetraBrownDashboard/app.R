...
# Get data
facilitator_data <- read_sheet("https://docs.google.com/spreadsheets/d/1f1V9bYx_3to7UNK1Q4qgKf0XnQJLxA94km5hPgIV4Kg/edit#gid=1078609200")

# Define UI for application that draws a histogram
ui <- navbarPage(

  # Application title
  titlePanel("Welcome to your dashboard Demetra Brown"),
