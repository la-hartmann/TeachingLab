...
# Get data
facilitator_data <- read_sheet("https://docs.google.com/spreadsheets/d/1oaT_LCjMc7PKp3pmNNmV8zlnczbhgApH7FMxTkaAw-8/edit#gid=1478362005")

# Define UI for application that draws a histogram
ui <- navbarPage(

  # Application title
  titlePanel("Welcome to your dashboard Andrea Johnson"),
