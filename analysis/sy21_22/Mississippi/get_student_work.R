...
#   ~ download.file(url = .x, destfile = paste0(here::here("Downloads/student_work/"), .y),
#                   method = "curl")
# )
...
files <- list.files(here::here("Downloads/student_work"), full.names = T)
