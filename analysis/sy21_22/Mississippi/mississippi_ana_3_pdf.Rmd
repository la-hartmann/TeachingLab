...
knowledge_assessments <- readr::read_rds(here::here("data/diagnostic.rds")) |>
...
## Global options
options(max.print = "75", width = 1000, dpi = 300)
opts_chunk$set(
  echo = FALSE,
  cache = T,
  prompt = FALSE,
...
-   Although the response rate was low for the second administration of
    the family survey, results point to **improvements in the family
    experience and their perception of student learning.**
...
coach_feedback_qual <- ongoing_coaching_feedback |>
  ...
  drop_na(value) |>
  filter(value != " ") |>
  rename(`Coaching Feedback` = value) |>
  TeachingLab::quote_viz(print = F)

gtsave(coach_feedback_qual, here::here("Images/Mississippi/coach_feedback_qual.png"), zoom = 1, vheight = 900, vwidth = 500)

knitr::include_graphics(here::here("Images/Mississippi/coach_feedback_qual.png"))
```
...
gtsave(went_well_gt, here::here("Images/Mississippi/went_well_gt.png"), zoom = 1, vheight = 900, vwidth = 500)

knitr::include_graphics(here::here("Images/Mississippi/went_well_gt.png"))
```
...
gtsave(could_better_gt, here::here("Images/Mississippi/could_better_gt.png"), zoom = 1, vheight = 900, vwidth = 500)

knitr::include_graphics(here::here("Images/Mississippi/could_better_gt.png"))
```
...
gtsave(add_feedback_gt, here::here("Images/Mississippi/add_feedback_gt.png"), zoom = 1, vheight = 900, vwidth = 500)

knitr::include_graphics(here::here("Images/Mississippi/add_feedback_gt.png"))
```
...
gtsave(gt1, here::here("Images/Mississippi/gt1.png"), zoom = 1, vheight = 900, vwidth = 500)

knitr::include_graphics(here::here("Images/Mississippi/gt1.png"))
```
...
gtsave(recognizing_gt, here::here("Images/Mississippi/recognizing_gt.png"), zoom = 1, vheight = 900, vwidth = 500)

knitr::include_graphics(here::here("Images/Mississippi/recognizing_gt.png"))
```
...
gtsave(high_expectations_gt, here::here("Images/Mississippi/high_expectations_gt.png"), zoom = 1, vheight = 900, vwidth = 500)

knitr::include_graphics(here::here("Images/Mississippi/high_expectations_gt.png"))
```
...
gtsave(crse_gt, here::here("Images/Mississippi/crse_gt.png"), zoom = 1, vheight = 900, vwidth = 500)

knitr::include_graphics(here::here("Images/Mississippi/crse_gt.png"))
```
...
gtsave(crse_gt, here::here("Images/Mississippi/knowledge_assessments_gt.png"), zoom = 1, vheight = 900, vwidth = 500)

knitr::include_graphics(here::here("Images/Mississippi/knowledge_assessments_gt.png"))
```
...
gtsave(student_learn_gt, here::here("Images/Mississippi/student_learn_gt.png"), zoom = 1, vheight = 900, vwidth = 500)

knitr::include_graphics(here::here("Images/Mississippi/student_learn_gt.png"))
...
gtsave(culturally_responsive_gt, here::here("Images/Mississippi/culturally_responsive_gt.png"), zoom = 1, vheight = 900, vwidth = 500)

knitr::include_graphics(here::here("Images/Mississippi/culturally_responsive_gt.png"))
```
...
gtsave(teacher_student_gt, here::here("Images/Mississippi/teacher_student_gt.png"), zoom = 1, vheight = 900, vwidth = 500)

knitr::include_graphics(here::here("Images/Mississippi/teacher_student_gt.png"))
```
...
gtsave(self_efficacy_gt, here::here("Images/Mississippi/self_efficacy_gt.png"), zoom = 1, vheight = 900, vwidth = 500)

knitr::include_graphics(here::here("Images/Mississippi/self_efficacy_gt.png"))
```
...
gtsave(happiness_belonging_gt, here::here("Images/Mississippi/happiness_belonging_gt.png"), zoom = 1, vheight = 900, vwidth = 500)

knitr::include_graphics(here::here("Images/Mississippi/happiness_belonging_gt.png"))
```
...
gtsave(being_challenged_gt, here::here("Images/Mississippi/being_challenged_gt.png"), zoom = 1, vheight = 900, vwidth = 500)

knitr::include_graphics(here::here("Images/Mississippi/being_challenged_gt.png"))
...
gtsave(student_math_gt, here::here("Images/Mississippi/student_math_gt.png"), zoom = 1, vheight = 900, vwidth = 500)

knitr::include_graphics(here::here("Images/Mississippi/student_math_gt.png"))
...
teacher_family <- family_survey |>
  mutate(bipoc = case_when(!is.na(`How do you describe your child’s race? You may check more than one box. - Native American Indian or Alaska Native`) ~ "BIPOC",
!is.na(`How do you describe your child’s race? You may check more than one box. - Asian`) ~ "BIPOC",
!is.na(`How do you describe your child’s race? You may check more than one box. - Black or African American`) ~ "BIPOC",
!is.na(`How do you describe your child’s race? You may check more than one box. - Native Hawaiian or Other Pacific Islander`) ~ "BIPOC",
!is.na(`How do you describe your child’s race? You may check more than one box. - White`) ~ "White",
!is.na(`How do you describe your child’s race? You may check more than one box. - Prefer not to say`) ~ "BIPOC",
!is.na(`How do you describe your child’s race? You may check more than one box. - Other (please specify)`) ~ "BIPOC")) |>
  drop_na(bipoc) |>
  dplyr::select(tidyselect::all_of(23:29), bipoc, prepost) |>
    janitor::remove_empty("rows") |>
    dplyr::group_by(bipoc, prepost) |>
    dplyr::summarise(dplyr::across(tidyselect::everything(), ~ TeachingLab::tl_score_numeric(as.character(.x)))) |>
    dplyr::ungroup() |>
    pivot_longer(!c(prepost, bipoc))
  
teacher_family_overall <- teacher_family |>
  group_by(prepost) |>
  dplyr::summarise(Percent = mean(value, na.rm = T)) |>
  pivot_wider(names_from = prepost, values_from = Percent)
...
family_exper_gt <- tibble::tibble(
  ...
  Pre = c(75,
          mean(teacher_family$value[teacher_family$prepost == "Pre"], na.rm = T),
          mean(teacher_student$value[teacher_student$prepost == "Pre"], na.rm = T)),
  Post = c(87,
           mean(teacher_family$value[teacher_family$prepost == "Post"], na.rm = T),
           mean(teacher_student$value[teacher_student$prepost == "Post"], na.rm = T))
) |>
  gt::gt() |>
  gt::fmt_markdown(columns = ` `) |>
  gt::fmt_percent(
...
gtsave(family_exper_gt, here::here("Images/Mississippi/family_exper_gt.png"), zoom = 1, vheight = 900, vwidth = 500)

knitr::include_graphics(here::here("Images/Mississippi/family_exper_gt.png"))
```
...
teacher_family_gt <- tibble::tibble(
  ` ` = c(
    ...
    teacher_family$name[teacher_family$prepost == "Post"]
  ),
    Pre = c(mean(teacher_family$value[teacher_family$prepost == "Pre"]),
            teacher_family |>
    group_by(prepost, name) |>
...
gtsave(teacher_family_gt, here::here("Images/Mississippi/teacher_family_gt.png"), zoom = 1, vheight = 900, vwidth = 500)

knitr::include_graphics(here::here("Images/Mississippi/teacher_family_gt.png"))
```
...
childs_assignments_gt <- family_survey |>
  ...
  gt::sub_missing(columns = c(Pre, Post),
                  missing_text = "") |>
  gt::data_color(
            columns = c(Pre, Post),
            colors = scales::col_bin(
...
gtsave(childs_assignments_gt, here::here("Images/Mississippi/childs_assignments_gt.png"), zoom = 1, vheight = 900, vwidth = 500)

knitr::include_graphics(here::here("Images/Mississippi/childs_assignments_gt.png"))
```
...
gtsave(child_exper_gt, here::here("Images/Mississippi/child_exper_gt.png"), zoom = 1, vheight = 900, vwidth = 500)

knitr::include_graphics(here::here("Images/Mississippi/child_exper_gt.png"))
```
