...
key1 %>%
  gtsave(here("Images/2021-2022/District11/el_key.png"))
```
...
key2 %>%
  gtsave(here("Images/2021-2022/District11/math_key.png"))
```
...
el_table_grouped <- fall_spring_el_averages %>%
  ...
  fmt_percent(
    columns = c(Fall, Spring, Improvement),
    decimals = 2,
    scale_values = F
  ) %>%
...
el_table_grouped %>%
  gtsave(filename = "GroupedSY19-20ELScores.png", path = here("Images/2021-2022/District11/"))
```
...
There were no matched samples in 2019-2020 for District 11.
...
el_table_grouped_matched %>%
  gtsave(filename = "GroupedSY19-20ELScores_Matched.png", path = here("Images/2021-2022/District11/"))
```
...
el_table %>%
  gtsave(here("Images/2021-2022/District11/SY19-20ELScores.png"))
```
...
```{r savetopdf, eval = F}
pagedown::chrome_print(input = here("Analysis/2021-2022/District11SY19-20/2019-2020District11.html"),
                       output = here("Analysis/2021-2022/District11SY19-20/2019-2020District11.pdf"))
```
