...
params:
  matched: "unmatched"
  partner: "Rochester City School District - District-wide"
...
followup_educator <- TeachingLab:::get_followup_educator() |>
  filter(str_detect(`Your site (district, parish, network, or school)`, "School District"))
...
diagnostic_survey <- diagnostic_survey |>
  ...
  filter(which_subject_area_do_you_teach_lead_if_you_teach_support_both_please_select_the_one_where_you_expect_to_work_with_teaching_lab_this_year_br_br == "Mathematics") |>
  slice_sample(n = 37)
...
followup_educator <- followup_educator |>
  ...
  filter(`Which subject area do you teach/ lead? If you teach/support both, please select the one for which you received support from Teaching Lab this year.` == "Mathematics") |>
  slice_sample(n = 21)

### Student Survey Read-in ###
rochester_student_survey <- read_sheet("https://docs.google.com/spreadsheets/d/1c4wbbQzt54BFV7oSLUoj6m0xajOKC5m1p-TH0Wo7HcM/edit#gid=1920829756") |>
  mutate(prepost = c(rep("Pre", 194),
                     rep("Post", 187)))

score_student_survey <- function(x, denom = 6, rev = F) {
  if (rev == F) {
    x <- suppressWarnings(as.numeric(str_replace_all(x, c(
                       "Extremely true" = "5",
                       "Very true" = "4",
                       "Somewhat true" = "3",
                       "Slightly true" = "2",
  ...
  score <- 100 * round(mean(x, na.rm = T)/denom, 2)
...
knowledge_assessments <- TeachingLab::get_knowledge_assessments() |>
  ...
  filter(n() > 10) |>
  ungroup() |>
  mutate(know_assess = str_replace_all(know_assess, 
...
-   `r prepared_agree[1]` strongly agree or agree that the facilitators
    were fully prepared for the session.
-   `r responded_agree[1]` strongly agree or agree that the facilitators
    responded to the group's needs.
-   `r facilitated_agree[1]` strongly agree or agree that the
    facilitators facilitated the content clearly.
-   `r effectively_agree[1]` strongly agree or agree that the
    facilitators effectively built a safe learning community.
-   `r demonstrated_agree[1]` strongly agree or agree that the
    facilitators demonstrated deep knowledge of the content they
    facilitated.
...
-   `r prepared_agree[2]` strongly agree or agree that the facilitators
    were fully prepared for the session.
-   `r responded_agree[2]` strongly agree or agree that the facilitators
    responded to the group's needs.
-   `r facilitated_agree[2]` strongly agree or agree that the
    facilitators facilitated the content clearly.
-   `r effectively_agree[2]` strongly agree or agree that the
    facilitators effectively built a safe learning community.
-   `r demonstrated_agree[2]` strongly agree or agree that the
    facilitators demonstrated deep knowledge of the content they
    facilitated.
...
-   `r paste0(mean(as.numeric(str_remove_all(quality_agree, "%"))), "%")`
    strongly agree or agree that they were satisfied with the overall
...
-   `r paste0(mean(as.numeric(str_remove_all(four_six_agree, "%"))), "%")`
    ...
    in the course to their practice.
-   `r paste0(mean(as.numeric(str_remove_all(implement_agree, "%"))), "%")`
    strongly agree or agree that the strategies they've learned in the
    course are easy to implement.
-   `r paste0(mean(as.numeric(str_remove_all(improve_supervision_agree, "%"))), "%")`
    strongly agree or agree that what they've learned in this course
    will improve my supervision of teachers.
-   `r paste0(mean(as.numeric(str_remove_all(improve_instruction_agree, "%"))), "%")`
    strongly agree or agree that what they've learned in this course
    will improve my instruction.
...
-   `r quality_agree[1]` strongly agree or agree that they were
    satisfied with the overall quality of the course.
-   `r facilitated_agree[1]` strongly agree or agree that they were
    satisfied with how the course was facilitated.
-   `r community_agree[1]` strongly agree or agree that they felt a
    sense of community with the other participants in the course.
-   `r four_six_agree[1]` strongly agree or agree that they will apply
    what they have learned in the course to their practice.
-   `r implement_agree[1]` strongly agree or agree that the strategies
    they've learned in the course are easy to implement.
-   `r improve_supervision_agree[1]` strongly agree or agree that what
    they've learned in this course will improve my supervision of
    teachers.
-   `r improve_instruction_agree[1]` strongly agree or agree that what
    they've learned in this course will improve my instruction.
-   `r supported_agree[1]` strongly agree or agree that the course has
...
-   `r quality_agree[2]` strongly agree or agree that they were
    satisfied with the overall quality of the course.
-   `r facilitated_agree[2]` strongly agree or agree that they were
    satisfied with how the course was facilitated.
-   `r community_agree[2]` strongly agree or agree that they felt a
    sense of community with the other participants in the course.
-   `r four_six_agree[2]` strongly agree or agree that they will apply
    what they have learned in the course to their practice.
-   `r implement_agree[2]` strongly agree or agree that the strategies
    they've learned in the course are easy to implement.
-   `r improve_supervision_agree[2]` strongly agree or agree that what
    they've learned in this course will improve my supervision of
    teachers.
-   `r improve_instruction_agree[2]` strongly agree or agree that what
    they've learned in this course will improve my instruction.
-   `r supported_agree[2]` strongly agree or agree that the course has
    supported me in being responsive to students' backgrounds, cultures,
    and points of view.
...
-   `r paste0(mean(as.numeric(str_remove_all(coach_clear_coaching_agree, "%"))), "%")`
    strongly agree or agree that the coaching was clear.
-   `r paste0(mean(as.numeric(str_remove_all(coach_adjustments_agree, "%"))), "%")`
    strongly agree or agree that the coaches made necessary adjustments
    based on my needs.
-   `r paste0(mean(as.numeric(str_remove_all(coach_prepared_agree, "%"))), "%")`
    strongly agree or agree that the coach seemed fully prepared for the
    coaching sessions.
-   `r paste0(mean(as.numeric(str_remove_all(coach_knowledge_agree, "%"))), "%")`
    strongly agree or agree that the coaches demonstrated deep knowledge
    of the content they coach.
-   `r paste0(mean(as.numeric(str_remove_all(coach_effectively_agree, "%"))), "%")`
    strongly agree or agree that the coaches built a safe learning
    environment.
...
-   `r coach_prepared_agree[1]` strongly agree or agree that the coach
    seemed fully prepared for the coaching sessions.
-   `r coach_adjustments_agree[1]` strongly agree or agree that the
    coaches made necessary adjustments based on my needs.
-   `r coach_effectively_agree[1]` strongly agree or agree that the
    coaches built a safe learning environment.
-   `r coach_knowledge_agree[1]` strongly agree or agree that the
    coaches demonstrated deep knowledge of the content they coach.
-   `r coach_clear_coaching_agree[1]` strongly agree or agree that the
    coaching was clear.
...
-   `r coach_clear_coaching_agree[2]` strongly agree or agree that the
    coaching was clear.
-   `r coach_knowledge_agree[2]` strongly agree or agree that the
    coaches demonstrated deep knowledge of the content they coach.
-   `r coach_prepared_agree[2]` strongly agree or agree that the coach
    seemed fully prepared for the coaching sessions.
-   `r coach_adjustments_agree[2]` strongly agree or agree that the
    coaches made necessary adjustments based on my needs.
-   `r coach_effectively_agree[2]` strongly agree or agree that the
    coaches built a safe learning environment.
...
the most often. For ELA subjects we see the following results:
...
Teachers were observed in order to determine the fidelity and integrity with which they were implementing the curriculum.

## Section 6a: Aggregate Ratings

19 classroom observations were carried out by Rochester school leaders in January and February. 79% of teachers observed were implementing the curriculum with fidelity/integrity.
...
growth_mindsets <- rochester_student_survey |>
  group_by(prepost) |>
  summarise(across(c(14:17), ~ score_student_survey(.x, denom = 6, rev = T)),
            across(c(18), ~ score_student_survey(.x, denom = 5)),
            across(c(19), ~ score_student_survey(.x, denom = 6))) |>
  pivot_longer(!prepost) |>
  mutate(name = str_remove_all(name, "How much do you agree or disagree with the statements below\\? \\- ")) |>
  pivot_wider(names_from = prepost, values_from = value) |>
  relocate(Post, .after = Pre)

achievement_identity <- rochester_student_survey |>
  select(20:21, prepost) |>
  group_by(prepost) |>
  summarise(across(everything(), ~ score_student_survey(.x, denom = 6))) |>
  pivot_longer(!prepost) |>
  mutate(name = str_remove_all(name, "How much do you agree or disagree with the statements below\\? \\- ")) |>
  pivot_wider(names_from = prepost, values_from = value) |>
  relocate(Post, .after = Pre)

self_efficacy <- rochester_student_survey |>
  select(22:24, prepost) |>
  group_by(prepost) |>
  summarise(across(everything(), ~ score_student_survey(.x, denom = 6))) |>
  pivot_longer(!prepost) |>
  mutate(name = str_remove_all(name, "How much do you agree or disagree with the statements below\\? \\- ")) |>
...
math_enjoyment <- rochester_student_survey |>
  select(25:28, prepost) |>
  group_by(prepost) |>
  summarise(across(everything(), ~ score_student_survey(.x, denom = 4))) |>
  pivot_longer(!prepost) |>
  mutate(name = str_remove_all(name, "How much do you agree or disagree with the statements below\\? \\- ")) |>
  pivot_wider(names_from = prepost, values_from = value) |>
  relocate(Post, .after = Pre)

meta_cognition <- rochester_student_survey |>
  select(29:33, prepost) |>
  group_by(prepost) |>
  summarise(across(c(2, 4:5), ~ score_student_survey(.x, denom = 5)),
            across(c(1, 3), ~ score_student_survey(.x, rev = T, denom = 5))) |>
  pivot_longer(!prepost) |>
  mutate(name = str_remove_all(name, "When reading the following statements, think about your current math class and decide how well the statements describe you\\. \\- ")) |>
  pivot_wider(names_from = prepost, values_from = value) |>
  relocate(Post, .after = Pre)

value_mathematics <- rochester_student_survey |>
  select(34:36, prepost) |>
  group_by(prepost) |>
  summarise(across(c(1:2), ~ score_student_survey(.x)),
            across(c(3), ~ score_student_survey(.x, rev = T))) |>
  pivot_longer(!prepost) |>
  mutate(name = str_remove_all(name, "When reading the following statements, think about your current math class and decide how well the statements describe you\\. \\- ")) |>
  pivot_wider(names_from = prepost, values_from = value) |>
  relocate(Post, .after = Pre)

math_task_persistence <- rochester_student_survey |>
  select(37:39, prepost) |>
  group_by(prepost) |>
  summarise(across(c(2:3), ~ score_student_survey(.x, denom = 5)),
            across(c(1), ~ score_student_survey(.x, rev = T, denom = 5))) |>
  pivot_longer(!prepost) |>
  mutate(name = str_remove_all(name, "When reading the following statements, think about your current math class and decide how well the statements describe you\\. \\- ")) |>
  pivot_wider(names_from = prepost, values_from = value) |>
  relocate(Post, .after = Pre)

agency <- rochester_student_survey |>
  select(40:41, prepost) |>
  group_by(prepost) |>
  summarise(across(c(1:2), ~ score_student_survey(.x, denom = 5))) |>
  pivot_longer(!prepost) |>
  mutate(name = str_remove_all(name, "When reading the following statements, think about your current math class and decide how well the statements describe you\\. \\- ")) |>
  pivot_wider(names_from = prepost, values_from = value) |>
  relocate(Post, .after = Pre)

student_crse <- rochester_student_survey |>
  select(42:43, prepost) |>
  group_by(prepost) |>
  summarise(across(c(1:2), ~ score_student_survey(.x, denom = 4))) |>
  pivot_longer(!prepost) |>
  mutate(name = str_remove_all(name, "How often does your math teacher do each of the following\\? \\- ")) |>
  pivot_wider(names_from = prepost, values_from = value) |>
  relocate(Post, .after = Pre)

overall_pre <- round(mean(c(growth_mindsets$Pre, achievement_identity$Pre, 
                      self_efficacy$Pre, math_enjoyment$Pre,
                      meta_cognition$Pre, value_mathematics$Pre,
                      math_task_persistence$Pre, agency$Pre,
                      student_crse$Pre)), 2)

overall_post <- round(mean(c(growth_mindsets$Post, achievement_identity$Post, 
                      self_efficacy$Post, math_enjoyment$Post,
                      meta_cognition$Post, value_mathematics$Post,
                      math_task_persistence$Post, agency$Post,
                      student_crse$Post)), 2)
...
tibble::tibble(
  ` ` = c(
    ...
    "Math Enjoyment",
    "Metacognition",
    "Value & Importance of Mathematics",
    "Math Task Persistence",
    "Agency",
    "Student Perceptions of Teachers' CRSE Practices"
  ),
  `Average Score Pre` = c(
    overall_pre,
    round(mean(growth_mindsets$Pre), 2), 
    round(mean(achievement_identity$Pre), 2), 
    round(mean(self_efficacy$Pre), 2), 
    round(mean(math_enjoyment$Pre), 2),
    round(mean(meta_cognition$Pre), 2), 
    round(mean(value_mathematics$Pre), 2),
    round(mean(math_task_persistence$Pre), 2), 
    round(mean(agency$Pre), 2),
    round(mean(student_crse$Pre), 2)),
  `Average Score Post` = c(
    overall_pre,
    round(mean(growth_mindsets$Post), 2), 
    round(mean(achievement_identity$Post), 2), 
    round(mean(self_efficacy$Post), 2), 
    round(mean(math_enjoyment$Post), 2),
    round(mean(meta_cognition$Post), 2), 
    round(mean(value_mathematics$Post), 2),
    round(mean(math_task_persistence$Post), 2), 
    round(mean(agency$Post), 2),
    round(mean(student_crse$Post), 2))
  ) |>
  gt::gt() |>
  gt::fmt_markdown(columns = ` `) |>
  gt::fmt_percent(
    columns = c(`Average Score Pre`, `Average Score Post`),
    scale_values = F,
    decimals = 0
  ) |>
  # gt::data_color(
  #   columns = c(`Average Score`),
  #   colors = scales::col_bin(
  #     palette = c(
  #       TeachingLab::tl_palette(n = 8, color = "blue") |> magrittr::extract(c(4, 6, 8))
  #     ),
  ...
  data_color(
    ...
    colors = scales::col_numeric(
      palette = TeachingLab::tl_palette(color = "blue"),
      domain = 40:90
    )
  ) |>
  gt::tab_source_note(
...
```{r growth-table, fig.dim = c(10, 7)}
tibble::tibble(
  ` ` = c(
    "<b>Overall Growth Mindsets Score</b>",
    growth_mindsets$name
  ),
  `Average Score Pre` = c(
    round(mean(growth_mindsets$Pre), 2),
    growth_mindsets$Pre
...
```{r achievement-identity-table, fig.dim = c(8, 5)}
tibble::tibble(
  ` ` = c(
    "<b>Overall Achievement Identity Score</b>",
    achievement_identity$name
  ),
  `Average Score Pre` = c(
    round(mean(achievement_identity$Pre), 2),
    achievement_identity$Pre
  ),
  `Average Score Post` = c(
    round(mean(achievement_identity$Post), 2),
    achievement_identity$Post
  )
) |>
  gt::gt() |>
  gt::fmt_markdown(columns = ` `) |>
...
```{r math-enjoyment-table, fig.dim = c(9, 8)}
tibble::tibble(
  ` ` = c(
    "<b>Overall Math Enjoyment Score</b>",
    math_enjoyment$name
  ),
  `Average Score Pre` = c(
    round(mean(math_enjoyment$Pre), 2),
...
```{r metacognition-table, fig.dim = c(10, 7)}
tibble::tibble(
  ` ` = c(
    "<b>Overall Metacognition Score</b>",
    meta_cognition$name
  ),
  `Average Score Pre` = c(
    round(mean(meta_cognition$Pre), 2),
...
```{r value-mathematics-table, fig.dim = c(10, 7)}
tibble::tibble(
  ` ` = c(
    "<b>Overall Value & Importance of Mathematics Score</b>",
    value_mathematics$name
  ),
  `Average Score Pre` = c(
    round(mean(value_mathematics$Pre), 2),
    value_mathematics$Pre
  ),
  `Average Score Post` = c(
    round(mean(value_mathematics$Post), 2),
    value_mathematics$Post
  )
) |>
  gt::gt() |>
  gt::fmt_markdown(columns = ` `) |>
...
```{r math-task-table, fig.dim = c(10, 7)}
tibble::tibble(
  ` ` = c(
    "<b>Overall Math Task Persistence Score</b>",
    math_task_persistence$name
  ),
  `Average Score Pre` = c(
    round(mean(math_task_persistence$Pre), 2),
    math_task_persistence$Pre
  ),
  `Average Score Post` = c(
    round(mean(math_task_persistence$Post), 2),
    math_task_persistence$Post
  )
) |>
  gt::gt() |>
  gt::fmt_markdown(columns = ` `) |>
...
```{r agency-table, fig.dim = c(10, 7)}
tibble::tibble(
  ` ` = c(
    "<b>Overall Agency Score</b>",
    agency$name
  ),
  `Average Score Pre` = c(
    round(mean(agency$Pre), 2),
...
### Student Perception of Teachers' CRSE Practices

::: {.fold .o}
<center>

```{r crse-practices-table, fig.dim = c(10, 7)}
tibble::tibble(
  ` ` = c(
    "<b>Overall Student Perception of Teachers' CRSE Practices Score</b>",
    student_crse$name
  ),
  `Average Score Pre` = c(
    round(mean(student_crse$Pre), 2),
...
## Section 7b: Student Math Proficiency
...
tibble::tibble(
  ...
  TeachingLab::gt_theme_tl() |>
  gtsave("student_math_proficiency.png", path = tempdir(), zoom = 4)
```
