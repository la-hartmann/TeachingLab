...
Starting from October 1 there were 171 responses given by San Diego Unified School District participants, they largely gave positive feedback when asked questions about a variety of ways to assess the effectiveness of the facilitation of their courses.
...
plot_agree <- session_survey %>%
        dplyr::filter(Date > as.Date("2021-10-01")) %>%
...
#         ) %>%
#     gtsave("img1.png", path = here::here("Images/2021-2022/Mathematica"))
...
#         width = 20, align = "center"
#       ) %>%
#   gtsave("img2.png", path = here::here("Images/2021-2022/Mathematica"))
...
#         ) %>%
#     gtsave("img3.png", path = here::here("Images/2021-2022/Mathematica"))
