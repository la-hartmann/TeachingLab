...
session_survey <- read_rds(here::here("data/session_survey_21_22data.rds")) %>%
  dplyr::filter(str_detect(`Select your site (district, parish, network, or school). - Other (please specify)`, "channel") | `Select your site (district, parish, network, or school).` == "NYC District 27, Channel View School for Research, NY")

# session_report_data %>%
#   TeachingLab::session_agree_plot()
# 
# session_report_data %>%
#   TeachingLab::session_agree_plot_ts(scale = "1 month")
# 
# session_report_data %>%
#   TeachingLab::session_quotes()
...
There were 7 identifiable responses given by Channel View School District participants, they largely gave positive feedback when asked questions about a variety of ways to assess the effectiveness of the facilitation of their courses.
...
session_survey %>%
  ...
  quote_viz(
    ...
    gtsave("img1.png", path = here::here("Images/2021-2022/Channelview"))
knitr::include_graphics(here::here("Images/2021-2022/Channelview/img1.png"))
```
...
session_survey %>%
  ...
  gtsave("img2.png", path = here::here("Images/2021-2022/Channelview"))
knitr::include_graphics(here::here("Images/2021-2022/Channelview/img2.png"))
```
...
session_survey %>%
  ...
  quote_viz(
    ...
    gtsave("img3.png", path = here::here("Images/2021-2022/Channelview"))
knitr::include_graphics(here::here("Images/2021-2022/Channelview/img3.png"))
```
