...
if (params$partner != "All Partners") {
  ...
  matched_2021 <- read_rds(here::here("Data-Clean/Data-move/SY20-21/matched_2021.rds")) %>%
    filter(post_subject == "ELA/Literacy" | pre_subject == "ELA/Literacy")
...
The overall nps for ELA content in 2020-2021 was `r paste0(overall)`
